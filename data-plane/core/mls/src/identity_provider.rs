    ...
    V: Verifier + Send + Sync + Clone + 'static,
{
    ...
    fn validate_member(
        ...
        self.do_validate_member(signing_identity)
    }
    ...
    fn identity(
        ...
        self.do_identity(signing_identity)
    }
    ...
    fn valid_successor(
        ...
        self.do_valid_successor(predecessor, successor)
    }
